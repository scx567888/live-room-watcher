...
/**
 * <p>GiftMessageOrBuilder interface.</p>
 *
 * @author scx567888
 * @version $Id: $Id
 */
public interface GiftMessageOrBuilder extends
   ...
   * @return The toUser.
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.User getToUser();
  /**
   * <code>.User toUser = 8;</code>
   *
   * @return a {@link cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.UserOrBuilder} object
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.UserOrBuilder getToUserOrBuilder();
   ...
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.im.GiftMessage.TextEffect getTextEffect();
  /**
   * <code>.GiftMessage.TextEffect textEffect = 10;</code>
   *
   * @return a {@link cool.scx.live_room_watcher.douyin.proto_entity.webcast.im.GiftMessage.TextEffectOrBuilder} object
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.im.GiftMessage.TextEffectOrBuilder getTextEffectOrBuilder();
   ...
   * @return The priority.
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.GiftIMPriority getPriority();
  /**
   * <code>.GiftIMPriority priority = 14;</code>
   *
   * @return a {@link cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.GiftIMPriorityOrBuilder} object
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.GiftIMPriorityOrBuilder getPriorityOrBuilder();
   ...
   * @return The gift.
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.GiftStruct getGift();
  /**
   * <code>.GiftStruct gift = 15;</code>
   *
   * @return a {@link cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.GiftStructOrBuilder} object
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.GiftStructOrBuilder getGiftOrBuilder();
   ...
   * @return The trayInfo.
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.GiftTrayInfo getTrayInfo();
  /**
   * <code>.GiftTrayInfo trayInfo = 21;</code>
   *
   * @return a {@link cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.GiftTrayInfoOrBuilder} object
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.GiftTrayInfoOrBuilder getTrayInfoOrBuilder();
   ...
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.AssetEffectMixInfo getAssetEffectMixInfo();
  /**
   * <code>.AssetEffectMixInfo assetEffectMixInfo = 24;</code>
   *
   * @return a {@link cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.AssetEffectMixInfoOrBuilder} object
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.AssetEffectMixInfoOrBuilder getAssetEffectMixInfoOrBuilder();
   ...
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.AnchorGiftData getAnchorGift();
  /**
   * <code>.AnchorGiftData anchorGift = 31;</code>
   *
   * @return a {@link cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.AnchorGiftDataOrBuilder} object
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.AnchorGiftDataOrBuilder getAnchorGiftOrBuilder();
