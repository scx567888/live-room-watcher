...
public interface ScreenChatMessageOrBuilder extends
   ...
   * @return The effect.
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.im.ScreenChatMessage.Effect getEffect();
  /**
   * <code>.ScreenChatMessage.Effect effect = 6;</code>
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.im.ScreenChatMessage.EffectOrBuilder getEffectOrBuilder();
   ...
   * @return The effectV2.
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.im.ScreenChatMessage.Effect getEffectV2();
  /**
   * <code>.ScreenChatMessage.Effect effectV2 = 8;</code>
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.im.ScreenChatMessage.EffectOrBuilder getEffectV2OrBuilder();
   ...
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.im.ScreenChatMessage.OfficialCommentConfig getOfficialCommentConfig();
  /**
   * <code>.ScreenChatMessage.OfficialCommentConfig officialCommentConfig = 11;</code>
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.im.ScreenChatMessage.OfficialCommentConfigOrBuilder getOfficialCommentConfigOrBuilder();
   ...
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.ChatIdentity getChatIdentityInfo();
  /**
   * <code>.ChatIdentity chatIdentityInfo = 14;</code>
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.ChatIdentityOrBuilder getChatIdentityInfoOrBuilder();
   ...
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.Text getRtfContent();
  /**
   * <code>.Text rtfContent = 30;</code>
   */
  cool.scx.live_room_watcher.douyin.proto_entity.webcast.data.TextOrBuilder getRtfContentOrBuilder();
}
