...
public class Main {
    ...
    public static void main(String[] args) {
        var liveRoomWatcher = new DouYinLiveRoomWatcher("https://live.douyin.com/357626301151?cover_type=0&enter_from_merge=web_live&enter_method=web_card&game_name=&is_recommend=1&live_type=game&more_detail=&request_id=20230111140841D93924E3E605200A8F7C&room_id=7187259125934476069&stream_type=horizontal&title_type=1&web_live_page=hot_live&web_live_tab=all");
