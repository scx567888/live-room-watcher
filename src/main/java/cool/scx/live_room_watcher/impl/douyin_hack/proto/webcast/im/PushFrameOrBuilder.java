...
public interface PushFrameOrBuilder extends
    // @@protoc_insertion_point(interface_extends:webcast.im.PushFrame)
   ...
   */
  java.util.List<cool.scx.live_room_watcher.impl.douyin_hack.proto.webcast.im.PushHeader> 
      getHeadersList();
  /**
   * <code>repeated .webcast.im.PushHeader headers = 5;</code>
   */
  cool.scx.live_room_watcher.impl.douyin_hack.proto.webcast.im.PushHeader getHeaders(int index);
  /**
   * <code>repeated .webcast.im.PushHeader headers = 5;</code>
   */
  int getHeadersCount();
   ...
   * <code>repeated .webcast.im.PushHeader headers = 5;</code>
   */
  java.util.List<? extends cool.scx.live_room_watcher.impl.douyin_hack.proto.webcast.im.PushHeaderOrBuilder> 
      getHeadersOrBuilderList();
  /**
   * <code>repeated .webcast.im.PushHeader headers = 5;</code>
   */
  cool.scx.live_room_watcher.impl.douyin_hack.proto.webcast.im.PushHeaderOrBuilder getHeadersOrBuilder(
      int index);
