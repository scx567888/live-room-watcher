...
public interface ResponseOrBuilder extends
    // @@protoc_insertion_point(interface_extends:webcast.im.Response)
    com.google.protobuf.MessageOrBuilder {

  /**
   * <code>repeated .webcast.im.Message messages = 1;</code>
   */
  java.util.List<cool.scx.live_room_watcher.impl.douyin_hack.proto.webcast.im.Message> 
      getMessagesList();
  /**
   * <code>repeated .webcast.im.Message messages = 1;</code>
   */
  cool.scx.live_room_watcher.impl.douyin_hack.proto.webcast.im.Message getMessages(int index);
  /**
   * <code>repeated .webcast.im.Message messages = 1;</code>
   */
   ...
   * <code>repeated .webcast.im.Message messages = 1;</code>
   */
  java.util.List<? extends cool.scx.live_room_watcher.impl.douyin_hack.proto.webcast.im.MessageOrBuilder> 
      getMessagesOrBuilderList();
  /**
   * <code>repeated .webcast.im.Message messages = 1;</code>
   */
  cool.scx.live_room_watcher.impl.douyin_hack.proto.webcast.im.MessageOrBuilder getMessagesOrBuilder(
      int index);
   ...
   */
  java.lang.String getPushServerV2();
  /**
   * <code>string push_server_v2 = 14;</code>
