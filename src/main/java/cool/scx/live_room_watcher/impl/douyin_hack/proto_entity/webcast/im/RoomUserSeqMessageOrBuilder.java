...
public interface RoomUserSeqMessageOrBuilder extends
   ...
   */
  java.util.List<cool.scx.live_room_watcher.impl.douyin_hack.proto_entity.webcast.im.RoomUserSeqMessage.Contributor> 
      getRanksListList();
  /**
   * <code>repeated .RoomUserSeqMessage.Contributor ranksList = 2;</code>
   */
  cool.scx.live_room_watcher.impl.douyin_hack.proto_entity.webcast.im.RoomUserSeqMessage.Contributor getRanksList(int index);
  /**
   * <code>repeated .RoomUserSeqMessage.Contributor ranksList = 2;</code>
   */
   ...
   * <code>repeated .RoomUserSeqMessage.Contributor ranksList = 2;</code>
   */
  java.util.List<? extends cool.scx.live_room_watcher.impl.douyin_hack.proto_entity.webcast.im.RoomUserSeqMessage.ContributorOrBuilder> 
      getRanksListOrBuilderList();
  /**
   * <code>repeated .RoomUserSeqMessage.Contributor ranksList = 2;</code>
   */
  cool.scx.live_room_watcher.impl.douyin_hack.proto_entity.webcast.im.RoomUserSeqMessage.ContributorOrBuilder getRanksListOrBuilder(
      int index);
   ...
   * <code>repeated .RoomUserSeqMessage.Contributor seatsList = 5;</code>
   */
  cool.scx.live_room_watcher.impl.douyin_hack.proto_entity.webcast.im.RoomUserSeqMessage.Contributor getSeatsList(int index);
  /**
   * <code>repeated .RoomUserSeqMessage.Contributor seatsList = 5;</code>
   */
   ...
   * <code>repeated .RoomUserSeqMessage.Contributor seatsList = 5;</code>
   */
  cool.scx.live_room_watcher.impl.douyin_hack.proto_entity.webcast.im.RoomUserSeqMessage.ContributorOrBuilder getSeatsListOrBuilder(
      int index);
