...
public interface GiftMessageOrBuilder extends
   ...
   * @return The toUser.
   */
  cool.scx.live_room_watcher.douyin_hack.proto_entity.webcast.data.User getToUser();
  /**
   * <code>.User toUser = 8;</code>
   */
  cool.scx.live_room_watcher.douyin_hack.proto_entity.webcast.data.UserOrBuilder getToUserOrBuilder();
   ...
   */
  cool.scx.live_room_watcher.douyin_hack.proto_entity.webcast.im.GiftMessage.TextEffect getTextEffect();
  /**
   * <code>.GiftMessage.TextEffect textEffect = 10;</code>
   */
  cool.scx.live_room_watcher.douyin_hack.proto_entity.webcast.im.GiftMessage.TextEffectOrBuilder getTextEffectOrBuilder();
   ...
   * @return The priority.
   */
  cool.scx.live_room_watcher.douyin_hack.proto_entity.webcast.data.GiftIMPriority getPriority();
  /**
   * <code>.GiftIMPriority priority = 14;</code>
   */
  cool.scx.live_room_watcher.douyin_hack.proto_entity.webcast.data.GiftIMPriorityOrBuilder getPriorityOrBuilder();
   ...
   * @return The gift.
   */
  cool.scx.live_room_watcher.douyin_hack.proto_entity.webcast.data.GiftStruct getGift();
  /**
   * <code>.GiftStruct gift = 15;</code>
   */
  cool.scx.live_room_watcher.douyin_hack.proto_entity.webcast.data.GiftStructOrBuilder getGiftOrBuilder();
   ...
   */
  cool.scx.live_room_watcher.douyin_hack.proto_entity.webcast.im.PublicAreaCommon getPublicAreaCommon();
  /**
   * <code>.PublicAreaCommon publicAreaCommon = 18;</code>
   */
  cool.scx.live_room_watcher.douyin_hack.proto_entity.webcast.im.PublicAreaCommonOrBuilder getPublicAreaCommonOrBuilder();
   ...
   */
  cool.scx.live_room_watcher.douyin_hack.proto_entity.webcast.data.Text getTrayDisplayText();
  /**
   * <code>.Text trayDisplayText = 19;</code>
   */
  cool.scx.live_room_watcher.douyin_hack.proto_entity.webcast.data.TextOrBuilder getTrayDisplayTextOrBuilder();
   ...
   * @return The trayInfo.
   */
  cool.scx.live_room_watcher.douyin_hack.proto_entity.webcast.data.GiftTrayInfo getTrayInfo();
  /**
   * <code>.GiftTrayInfo trayInfo = 21;</code>
   */
  cool.scx.live_room_watcher.douyin_hack.proto_entity.webcast.data.GiftTrayInfoOrBuilder getTrayInfoOrBuilder();
   ...
   */
  cool.scx.live_room_watcher.douyin_hack.proto_entity.webcast.data.AssetEffectMixInfo getAssetEffectMixInfo();
  /**
   * <code>.AssetEffectMixInfo assetEffectMixInfo = 24;</code>
   */
  cool.scx.live_room_watcher.douyin_hack.proto_entity.webcast.data.AssetEffectMixInfoOrBuilder getAssetEffectMixInfoOrBuilder();
   ...
   */
  cool.scx.live_room_watcher.douyin_hack.proto_entity.webcast.data.AnchorGiftData getAnchorGift();
  /**
   * <code>.AnchorGiftData anchorGift = 31;</code>
   */
  cool.scx.live_room_watcher.douyin_hack.proto_entity.webcast.data.AnchorGiftDataOrBuilder getAnchorGiftOrBuilder();
