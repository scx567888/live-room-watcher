...
public interface GiftStructOrBuilder extends
   ...
   * @return The image.
   */
  cool.scx.live_room_watcher.douyin_hack.proto_entity.webcast.data.Image getImage();
  /**
   * <code>.Image image = 1;</code>
   */
  cool.scx.live_room_watcher.douyin_hack.proto_entity.webcast.data.ImageOrBuilder getImageOrBuilder();
   ...
   */
  cool.scx.live_room_watcher.douyin_hack.proto_entity.webcast.data.GiftStruct.GiftStructFansClubInfo getFansclubInfo();
  /**
   * <code>.GiftStruct.GiftStructFansClubInfo fansclubInfo = 6;</code>
   */
  cool.scx.live_room_watcher.douyin_hack.proto_entity.webcast.data.GiftStruct.GiftStructFansClubInfoOrBuilder getFansclubInfoOrBuilder();
   ...
   */
  cool.scx.live_room_watcher.douyin_hack.proto_entity.webcast.data.Image getGiftLabelIcon();
  /**
   * <code>.Image giftLabelIcon = 15;</code>
   */
  cool.scx.live_room_watcher.douyin_hack.proto_entity.webcast.data.ImageOrBuilder getGiftLabelIconOrBuilder();
   ...
   */
  java.util.List<cool.scx.live_room_watcher.douyin_hack.proto_entity.webcast.data.LuckyMoneyGiftMeta> 
      getSubsList();
  /**
   * <code>repeated .LuckyMoneyGiftMeta subs = 25;</code>
   */
  cool.scx.live_room_watcher.douyin_hack.proto_entity.webcast.data.LuckyMoneyGiftMeta getSubs(int index);
  /**
   * <code>repeated .LuckyMoneyGiftMeta subs = 25;</code>
   */
  int getSubsCount();
   ...
   * <code>repeated .LuckyMoneyGiftMeta subs = 25;</code>
   */
  java.util.List<? extends cool.scx.live_room_watcher.douyin_hack.proto_entity.webcast.data.LuckyMoneyGiftMetaOrBuilder> 
      getSubsOrBuilderList();
  /**
   * <code>repeated .LuckyMoneyGiftMeta subs = 25;</code>
   */
  cool.scx.live_room_watcher.douyin_hack.proto_entity.webcast.data.LuckyMoneyGiftMetaOrBuilder getSubsOrBuilder(
      int index);
   ...
   */
  cool.scx.live_room_watcher.douyin_hack.proto_entity.webcast.data.GiftPanelOperation getGiftOperation();
  /**
   * <code>.GiftPanelOperation giftOperation = 30;</code>
   */
  cool.scx.live_room_watcher.douyin_hack.proto_entity.webcast.data.GiftPanelOperationOrBuilder getGiftOperationOrBuilder();
   ...
   */
  cool.scx.live_room_watcher.douyin_hack.proto_entity.webcast.data.GiftBanner getGiftBanner();
  /**
   * <code>.GiftBanner giftBanner = 43;</code>
   */
  cool.scx.live_room_watcher.douyin_hack.proto_entity.webcast.data.GiftBannerOrBuilder getGiftBannerOrBuilder();
   ...
   */
  java.util.List<cool.scx.live_room_watcher.douyin_hack.proto_entity.webcast.data.GiftBuffInfo> 
      getGiftBuffInfosList();
  /**
   * <code>repeated .GiftBuffInfo giftBuffInfos = 45;</code>
   */
  cool.scx.live_room_watcher.douyin_hack.proto_entity.webcast.data.GiftBuffInfo getGiftBuffInfos(int index);
  /**
   * <code>repeated .GiftBuffInfo giftBuffInfos = 45;</code>
   */
   ...
   * <code>repeated .GiftBuffInfo giftBuffInfos = 45;</code>
   */
  java.util.List<? extends cool.scx.live_room_watcher.douyin_hack.proto_entity.webcast.data.GiftBuffInfoOrBuilder> 
      getGiftBuffInfosOrBuilderList();
  /**
   * <code>repeated .GiftBuffInfo giftBuffInfos = 45;</code>
   */
  cool.scx.live_room_watcher.douyin_hack.proto_entity.webcast.data.GiftBuffInfoOrBuilder getGiftBuffInfosOrBuilder(
      int index);
   ...
   */
  cool.scx.live_room_watcher.douyin_hack.proto_entity.webcast.data.Image getDynamicImgForSelected();
  /**
   * <code>.Image dynamicImgForSelected = 47;</code>
   */
  cool.scx.live_room_watcher.douyin_hack.proto_entity.webcast.data.ImageOrBuilder getDynamicImgForSelectedOrBuilder();
   ...
   */
  cool.scx.live_room_watcher.douyin_hack.proto_entity.webcast.data.Image getTopRightAvatar();
  /**
   * <code>.Image topRightAvatar = 51;</code>
   */
  cool.scx.live_room_watcher.douyin_hack.proto_entity.webcast.data.ImageOrBuilder getTopRightAvatarOrBuilder();
   ...
   */
  cool.scx.live_room_watcher.douyin_hack.proto_entity.webcast.data.GiftPreviewInfo getGiftPreviewInfo();
  /**
   * <code>.GiftPreviewInfo giftPreviewInfo = 56;</code>
   */
  cool.scx.live_room_watcher.douyin_hack.proto_entity.webcast.data.GiftPreviewInfoOrBuilder getGiftPreviewInfoOrBuilder();
   ...
   * @return The giftTip.
   */
  cool.scx.live_room_watcher.douyin_hack.proto_entity.webcast.data.GiftTip getGiftTip();
  /**
   * <code>.GiftTip giftTip = 57;</code>
   */
  cool.scx.live_room_watcher.douyin_hack.proto_entity.webcast.data.GiftTipOrBuilder getGiftTipOrBuilder();
   ...
   */
  java.util.List<cool.scx.live_room_watcher.douyin_hack.proto_entity.webcast.data.GiftGroupInfo> 
      getGroupInfoList();
  /**
   * <code>repeated .GiftGroupInfo groupInfo = 59;</code>
   */
  cool.scx.live_room_watcher.douyin_hack.proto_entity.webcast.data.GiftGroupInfo getGroupInfo(int index);
  /**
   * <code>repeated .GiftGroupInfo groupInfo = 59;</code>
   */
   ...
   * <code>repeated .GiftGroupInfo groupInfo = 59;</code>
   */
  java.util.List<? extends cool.scx.live_room_watcher.douyin_hack.proto_entity.webcast.data.GiftGroupInfoOrBuilder> 
      getGroupInfoOrBuilderList();
  /**
   * <code>repeated .GiftGroupInfo groupInfo = 59;</code>
   */
  cool.scx.live_room_watcher.douyin_hack.proto_entity.webcast.data.GiftGroupInfoOrBuilder getGroupInfoOrBuilder(
      int index);
}
