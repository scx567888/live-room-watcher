...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushFrameOuterClass.internal_static_PushFrame_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushFrameOuterClass.internal_static_PushFrame_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushFrame.class, cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushFrame.Builder.class);
  }
  ...
  private java.util.List<cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushHeader> headersList_;
  /**
   * <code>repeated .PushHeader headersList = 5;</code>
   */
  @java.lang.Override
  public java.util.List<cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushHeader> getHeadersListList() {
    return headersList_;
  }
  /**
   * <code>repeated .PushHeader headersList = 5;</code>
   */
  @java.lang.Override
  public java.util.List<? extends cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushHeaderOrBuilder> 
   ...
   */
  @java.lang.Override
  public cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushHeader getHeadersList(int index) {
   ...
   */
  @java.lang.Override
  public cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushHeaderOrBuilder getHeadersListOrBuilder(
      int index) {
    return headersList_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushFrame)) {
      return super.equals(obj);
    }
    cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushFrame other = (cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushFrame) obj;
  ...
  public static cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushFrame parseFrom(
  ...
  public static cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushFrame parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushFrame parseFrom(
  ...
  public static cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushFrame parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushFrame parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }

  public static cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushFrame parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushFrame prototype) {
  ...
  public static final class Builder extends
      ...
      cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushFrameOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushFrameOuterClass.internal_static_PushFrame_descriptor;
    }
    ...
    // Construct using cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushFrame.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushFrame getDefaultInstanceForType() {
      return cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushFrame.getDefaultInstance();
    }

    @java.lang.Override
    public cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushFrame build() {
      cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushFrame result = buildPartial();
    ...
    @java.lang.Override
    public cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushFrame buildPartial() {
      cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushFrame result = new cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushFrame(this);
    ...
    private void buildPartialRepeatedFields(cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushFrame result) {
      if (headersListBuilder_ == null) {
    ...
    private void buildPartial0(cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushFrame result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushFrame) {
        return mergeFrom((cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushFrame)other);
      } else {
    ...
    public Builder mergeFrom(cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushFrame other) {
      if (other == cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushFrame.getDefaultInstance()) return this;
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 42: {
              cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushHeader m =
                  input.readMessage(
                      cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushHeader.parser(),
                      extensionRegistry);
              if (headersListBuilder_ == null) {
                ensureHeadersListIsMutable();
                headersList_.add(m);
    ...
    private void ensureHeadersListIsMutable() {
      if (!((bitField0_ & 0x00000010) != 0)) {
        headersList_ = new java.util.ArrayList<cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushHeader>(headersList_);
        bitField0_ |= 0x00000010;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushHeader, cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushHeader.Builder, cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushHeaderOrBuilder> headersListBuilder_;
    ...
    public Builder setHeadersList(
        int index, cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushHeader value) {
      if (headersListBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setHeadersList(
        int index, cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushHeader.Builder builderForValue) {
      if (headersListBuilder_ == null) {
        ensureHeadersListIsMutable();
     ...
     * <code>repeated .PushHeader headersList = 5;</code>
     */
    public Builder addHeadersList(cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushHeader value) {
      if (headersListBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addHeadersList(
        cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushHeader.Builder builderForValue) {
      if (headersListBuilder_ == null) {
        ensureHeadersListIsMutable();
    ...
    public Builder addAllHeadersList(
        java.lang.Iterable<? extends cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushHeader> values) {
      if (headersListBuilder_ == null) {
        ensureHeadersListIsMutable();
     ...
     * <code>repeated .PushHeader headersList = 5;</code>
     */
    public cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushHeader.Builder getHeadersListBuilder(
        int index) {
     ...
     * <code>repeated .PushHeader headersList = 5;</code>
     */
    public cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushHeader.Builder addHeadersListBuilder() {
      return getHeadersListFieldBuilder().addBuilder(
          cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushHeader.getDefaultInstance());
    }
    /**
     * <code>repeated .PushHeader headersList = 5;</code>
     */
    public cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushHeader.Builder addHeadersListBuilder(
        int index) {
      return getHeadersListFieldBuilder().addBuilder(
          index, cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushHeader.getDefaultInstance());
    }
    /**
     * <code>repeated .PushHeader headersList = 5;</code>
     */
    public java.util.List<cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushHeader.Builder> 
         getHeadersListBuilderList() {
      return getHeadersListFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushHeader, cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushHeader.Builder, cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushHeaderOrBuilder> 
  ...
  private static final cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushFrame DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushFrame();
  }

  public static cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushFrame getDefaultInstance() {
