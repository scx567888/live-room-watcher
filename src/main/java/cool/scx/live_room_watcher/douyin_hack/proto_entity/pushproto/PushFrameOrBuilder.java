...
public interface PushFrameOrBuilder extends
   ...
   */
  java.util.List<cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushHeader> 
      getHeadersListList();
  /**
   * <code>repeated .PushHeader headersList = 5;</code>
   */
  cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushHeader getHeadersList(int index);
  /**
   * <code>repeated .PushHeader headersList = 5;</code>
   */
   ...
   * <code>repeated .PushHeader headersList = 5;</code>
   */
  java.util.List<? extends cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushHeaderOrBuilder> 
      getHeadersListOrBuilderList();
  /**
   * <code>repeated .PushHeader headersList = 5;</code>
   */
  cool.scx.live_room_watcher.douyin_hack.proto_entity.pushproto.PushHeaderOrBuilder getHeadersListOrBuilder(
      int index);
