...
public interface ResponseOrBuilder extends
   ...
   */
  java.util.List<cool.scx.live_room_watcher.douyin_hack.proto_entity.webcast.im.Message> 
      getMessagesListList();
  /**
   * <code>repeated .Message messagesList = 1;</code>
   */
  cool.scx.live_room_watcher.douyin_hack.proto_entity.webcast.im.Message getMessagesList(int index);
  /**
   * <code>repeated .Message messagesList = 1;</code>
   */
   ...
   * <code>repeated .Message messagesList = 1;</code>
   */
  java.util.List<? extends cool.scx.live_room_watcher.douyin_hack.proto_entity.webcast.im.MessageOrBuilder> 
      getMessagesListOrBuilderList();
  /**
   * <code>repeated .Message messagesList = 1;</code>
   */
  cool.scx.live_room_watcher.douyin_hack.proto_entity.webcast.im.MessageOrBuilder getMessagesListOrBuilder(
      int index);
